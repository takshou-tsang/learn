...
################################################################################
## Form generated from reading UI file 'mainNnMsrf.ui'
##
...
"    background: 3px solid rgb(52, 59, 7"
                        "2);\n"
"	border: 3px solid rgb(52, 59, 72);	\n"
...
"	border: 2px solid rgb(114,46,209);\n"
"}\n"
...
"}")
        ...
        self.btn_ioboard = QPushButton(self.topMenu)
        self.btn_ioboard.setObjectName(u"btn_ioboard")
        self.btn_ioboard.setMinimumSize(QSize(0, 45))
        self.btn_ioboard.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-tags.png);")

        self.verticalLayout_8.addWidget(self.btn_ioboard)
        ...
        self.homeLeft = QFrame(self.home)
        self.homeLeft.setObjectName(u"homeLeft")
        self.homeLeft.setFrameShape(QFrame.Shape.StyledPanel)
        self.homeLeft.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_21 = QVBoxLayout(self.homeLeft)
        self.verticalLayout_21.setSpacing(0)
        self.verticalLayout_21.setObjectName(u"verticalLayout_21")
        self.verticalLayout_21.setContentsMargins(0, 0, 0, 0)
        self.homeToolBar = QFrame(self.homeLeft)
        self.homeToolBar.setObjectName(u"homeToolBar")
        self.homeToolBar.setMinimumSize(QSize(440, 50))
        self.homeToolBar.setMaximumSize(QSize(16777215, 50))
        self.homeToolBar.setFrameShape(QFrame.Shape.StyledPanel)
        self.homeToolBar.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_7 = QHBoxLayout(self.homeToolBar)
        self.horizontalLayout_7.setSpacing(10)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.horizontalLayout_7.setContentsMargins(10, 0, 10, 0)
        self.btn_shot = QPushButton(self.homeToolBar)
        self.buttonGroup = QButtonGroup(MainWindow)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.btn_shot)
        self.btn_shot.setObjectName(u"btn_shot")
        self.btn_shot.setMinimumSize(QSize(0, 40))
        self.btn_shot.setMaximumSize(QSize(120, 16777215))
        self.btn_shot.setCheckable(False)
        self.btn_shot.setAutoExclusive(False)

        self.horizontalLayout_7.addWidget(self.btn_shot)

        self.btn_predict = QPushButton(self.homeToolBar)
        self.buttonGroup.addButton(self.btn_predict)
        self.btn_predict.setObjectName(u"btn_predict")
        self.btn_predict.setMinimumSize(QSize(0, 40))
        self.btn_predict.setMaximumSize(QSize(120, 16777215))
        self.btn_predict.setStyleSheet(u"")
        self.btn_predict.setCheckable(True)
        self.btn_predict.setAutoExclusive(False)

        self.horizontalLayout_7.addWidget(self.btn_predict)

        self.btn_autoshot = QPushButton(self.homeToolBar)
        self.buttonGroup.addButton(self.btn_autoshot)
        self.btn_autoshot.setObjectName(u"btn_autoshot")
        self.btn_autoshot.setMinimumSize(QSize(0, 40))
        self.btn_autoshot.setMaximumSize(QSize(120, 16777215))
        self.btn_autoshot.setStyleSheet(u"")
        self.btn_autoshot.setCheckable(True)
        self.btn_autoshot.setAutoExclusive(False)

        self.horizontalLayout_7.addWidget(self.btn_autoshot)

        self.btn_continue = QPushButton(self.homeToolBar)
        self.buttonGroup.addButton(self.btn_continue)
        self.btn_continue.setObjectName(u"btn_continue")
        self.btn_continue.setMinimumSize(QSize(0, 40))
        self.btn_continue.setMaximumSize(QSize(120, 16777215))
        self.btn_continue.setStyleSheet(u"")
        self.btn_continue.setCheckable(True)
        self.btn_continue.setAutoExclusive(False)

        self.horizontalLayout_7.addWidget(self.btn_continue)

        self.btn_stop = QPushButton(self.homeToolBar)
        self.btn_stop.setObjectName(u"btn_stop")
        self.btn_stop.setMinimumSize(QSize(0, 40))
        self.btn_stop.setMaximumSize(QSize(120, 16777215))
        ...
        self.label_status = QLabel(self.homeToolBar)
        ...
        self.btn_predict.raise_()
        self.btn_autoshot.raise_()
        self.btn_continue.raise_()
        self.btn_stop.raise_()
        self.btn_shot.raise_()
        self.label_status.raise_()

        self.verticalLayout_21.addWidget(self.homeToolBar)

        self.image_view = QLabel(self.homeLeft)
        self.image_view.setObjectName(u"image_view")
        self.image_view.setStyleSheet(u"")

        self.verticalLayout_21.addWidget(self.image_view)


        self.horizontalLayout_6.addWidget(self.homeLeft)

        self.homeRight = QFrame(self.home)
        self.homeRight.setObjectName(u"homeRight")
        self.homeRight.setMinimumSize(QSize(300, 0))
        self.homeRight.setMaximumSize(QSize(300, 16777215))
        self.homeRight.setStyleSheet(u"")
        self.homeRight.setFrameShape(QFrame.Shape.StyledPanel)
        self.homeRight.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_22 = QVBoxLayout(self.homeRight)
        self.verticalLayout_22.setObjectName(u"verticalLayout_22")
        self.verticalLayout_22.setContentsMargins(0, 0, 0, 0)
        self.label_total = QLabel(self.homeRight)
        self.label_total.setObjectName(u"label_total")
        self.label_total.setMinimumSize(QSize(0, 50))
        self.label_total.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_22.addWidget(self.label_total)

        self.label_result = QLabel(self.homeRight)
        self.label_result.setObjectName(u"label_result")
        self.label_result.setMinimumSize(QSize(0, 150))
        self.label_result.setMaximumSize(QSize(16777215, 150))
        self.label_result.setStyleSheet(u"")
        self.label_result.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_22.addWidget(self.label_result)

        self.table_result = QTableWidget(self.homeRight)
        if (self.table_result.columnCount() < 4):
        ...
        self.table_result.setFrameShape(QFrame.Shape.NoFrame)
        self.table_result.setSizeAdjustPolicy(QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        self.table_result.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.table_result.setTabKeyNavigation(False)
        self.table_result.setProperty(u"showDropIndicator", False)
        self.table_result.setDragDropOverwriteMode(False)
        self.table_result.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.table_result.horizontalHeader().setCascadingSectionResizes(True)
        self.table_result.horizontalHeader().setDefaultSectionSize(66)
        self.table_result.horizontalHeader().setProperty(u"showSortIndicator", False)
        self.table_result.horizontalHeader().setStretchLastSection(True)
        self.table_result.verticalHeader().setVisible(False)

        self.verticalLayout_22.addWidget(self.table_result)

        self.table_result.raise_()
        self.label_result.raise_()
        self.label_total.raise_()

        self.horizontalLayout_6.addWidget(self.homeRight)

        self.stackedWidget.addWidget(self.home)
        self.camera_setting = QWidget()
        self.camera_setting.setObjectName(u"camera_setting")
        self.camera_setting.setStyleSheet(u"b")
        self.verticalLayout = QVBoxLayout(self.camera_setting)
        self.verticalLayout.setSpacing(10)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(10, 10, 10, 10)
        self.stackedWidget.addWidget(self.camera_setting)
        self.model_setting = QWidget()
        self.model_setting.setObjectName(u"model_setting")
        self.verticalLayout_20 = QVBoxLayout(self.model_setting)
        self.verticalLayout_20.setObjectName(u"verticalLayout_20")
        self.stackedWidget.addWidget(self.model_setting)
        self.io_setting = QWidget()
        self.io_setting.setObjectName(u"io_setting")
        self.stackedWidget.addWidget(self.io_setting)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleLeftApp.setText(QCoreApplication.translate("MainWindow", u"Defeat Detection", None))
        self.titleLeftDescription.setText(QCoreApplication.translate("MainWindow", u"AI driven", None))
        self.toggleButton.setText(QCoreApplication.translate("MainWindow", u"Hide", None))
        self.btn_home.setText(QCoreApplication.translate("MainWindow", u"\u8fd0\u884c", None))
        self.btn_camera.setText(QCoreApplication.translate("MainWindow", u"\u76f8\u673a\u914d\u7f6e", None))
        self.btn_setting.setText(QCoreApplication.translate("MainWindow", u"\u6a21\u578b\u914d\u7f6e", None))
        self.btn_ioboard.setText(QCoreApplication.translate("MainWindow", u"IO\u914d\u7f6e", None))
        self.titleRightInfo.setText(QCoreApplication.translate("MainWindow", u"AI\u89c6\u89c9\u68c0\u6d4b\u7cfb\u7edf", None))
        ...
        self.btn_shot.setText(QCoreApplication.translate("MainWindow", u"\u5355\u6b21\u62cd\u7167", None))
        self.btn_predict.setText(QCoreApplication.translate("MainWindow", u"\u5355\u6b21\u68c0\u6d4b", None))
        self.btn_autoshot.setText(QCoreApplication.translate("MainWindow", u"\u8fde\u7eed\u91c7\u56fe", None))
        self.btn_continue.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u52a8\u8fd0\u884c", None))
        self.btn_stop.setText(QCoreApplication.translate("MainWindow", u"\u505c\u6b62\u8fd0\u884c", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u8bbe\u7f6e\u503c", None));
        ___qtablewidgetitem2 = self.table_result.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"\u5b9e\u6d4b\u503c", None));
        ___qtablewidgetitem3 = self.table_result.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"\u5224\u65ad", None));
